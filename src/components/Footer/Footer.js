        ...
        return (
            <Fragment>
                <Container fluid={true} className="text-center footerSection">
                    <Row>
                        ...
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                            ...
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faEnvelope} /> ranam2292@gmail.com</p>
                            <p className="serviceDescription" > <FontAwesomeIcon  icon={faPhone} /> +8801774605537</p>
                        </Col>
                        <Col lg={3} md={6} sm={12} className="p-5 text-justify">
                ...
                <Container fluid={true} className="text-center copyrightSection">
                    <a className="copyrightLink" href="#">Masud.com &copy; 2020-2021</a>
                </Container>
