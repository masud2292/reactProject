...
import graphicsLogo from '../../asset/image/graphics.png'
import webLogo from '../../asset/image/web2.png'
import mobileLogo from '../../asset/image/mobile.webp'
                    ...
                    <Row>
                        <Col lg={4} md={6} sm={12}>
                           <div className="serviceCard text-center">
                               <img className="serviceCardImg" src={webLogo}/>
                        ...
                        <Col lg={4} md={6} sm={12}>
                            <div className="serviceCard text-center " >
                                <img className="serviceCardImg" src={mobileLogo}/>
                        ...
                        <Col lg={4} md={6} sm={12}>
                            <div className="serviceCard text-center">
                                <img className="serviceCardImg" src={graphicsLogo}/>
